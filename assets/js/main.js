...
(function($) {
  ...
  const targetDate = new Date("2026-03-07T14:00:00").getTime();
  ...
  function updateCountdown() {
    ...
    if (distance < 0) {
      document.getElementById("countdown").innerHTML = "<p>¡El gran día llegó! 💍</p>";
  ...
  const box      = document.getElementById('diet-options');
  ...
  yesBtn.addEventListener('click', () => {
    box.classList.add('is-open');          // 👈 mostrar con clase
    yesBtn.classList.add('is-active');
    noBtn.classList.remove('is-active');
  });

  noBtn.addEventListener('click', () => {
    box.classList.remove('is-open');       // 👈 ocultar con clase
